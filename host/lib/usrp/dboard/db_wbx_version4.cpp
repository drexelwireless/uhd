...
wbx_base::wbx_version4::wbx_version4(wbx_base *_self_wbx_base) {
    ...
    this->get_rx_subtree()->create<double>("freq/value")
         .coerce(std::bind(&wbx_base::wbx_version4::set_lo_freq, this, dboard_iface::UNIT_RX, std::placeholders::_1))
    ...
    BOOST_FOREACH(const std::string &name, wbx_v4_tx_gain_ranges.keys()){
        self_base->get_tx_subtree()->create<double>("gains/"+name+"/value")
            .coerce(std::bind(&wbx_base::wbx_version4::set_tx_gain, this, std::placeholders::_1, name))
    ...
    this->get_tx_subtree()->create<double>("freq/value")
         .coerce(std::bind(&wbx_base::wbx_version4::set_lo_freq, this, dboard_iface::UNIT_TX, std::placeholders::_1))
         .set((wbx_v4_freq_range.start() + wbx_v4_freq_range.stop())/2.0);
    this->get_tx_subtree()->create<meta_range_t>("freq/range").set(wbx_v4_freq_range);
    this->get_tx_subtree()->create<bool>("enabled")
        .subscribe(std::bind(&wbx_base::wbx_version4::set_tx_enabled, this, std::placeholders::_1))
