...
wbx_base::wbx_base(ctor_args_t args) : xcvr_dboard_base(args){
    ...
    this->get_rx_subtree()->create<sensor_value_t>("sensors/lo_locked")
        .publish(std::bind(&wbx_base::get_locked, this, dboard_iface::UNIT_RX));
    BOOST_FOREACH(const std::string &name, wbx_rx_gain_ranges.keys()){
        this->get_rx_subtree()->create<double>("gains/"+name+"/value")
            .coerce(std::bind(&wbx_base::set_rx_gain, this, std::placeholders::_1, name))
    ...
    this->get_rx_subtree()->create<bool>("enabled")
        .subscribe(std::bind(&wbx_base::set_rx_enabled, this, std::placeholders::_1))
    ...
    this->get_tx_subtree()->create<sensor_value_t>("sensors/lo_locked")
        .publish(std::bind(&wbx_base::get_locked, this, dboard_iface::UNIT_TX));
