...
public:
    ubx_xcvr(ctor_args_t args) : xcvr_dboard_base(args)
    {
        ...
        get_rx_subtree()->create<std::string>("power_mode/value")
            .subscribe(std::bind(&ubx_xcvr::set_power_mode, this, std::placeholders::_1))
            .set("performance");
        get_rx_subtree()->create<std::vector<std::string> >("xcvr_mode/options")
            .set(ubx_xcvr_modes);
        get_rx_subtree()->create<std::string>("xcvr_mode/value")
            .subscribe(std::bind(&ubx_xcvr::set_xcvr_mode, this, std::placeholders::_1))
            .set("FDX");
        get_tx_subtree()->create<std::vector<std::string> >("power_mode/options")
            .set(ubx_power_modes);
        get_tx_subtree()->create<std::string>("power_mode/value")
            .subscribe(std::bind(&uhd::property<std::string>::set, &get_rx_subtree()->access<std::string>("power_mode/value"), std::placeholders::_1))
            .publish(std::bind(&uhd::property<std::string>::get, &get_rx_subtree()->access<std::string>("power_mode/value")));
        get_tx_subtree()->create<std::vector<std::string> >("xcvr_mode/options")
            .set(ubx_xcvr_modes);
        get_tx_subtree()->create<std::string>("xcvr_mode/value")
            .subscribe(std::bind(&uhd::property<std::string>::set, &get_rx_subtree()->access<std::string>("xcvr_mode/value"), std::placeholders::_1))
            .publish(std::bind(&uhd::property<std::string>::get, &get_rx_subtree()->access<std::string>("xcvr_mode/value")));
        ...
        get_tx_subtree()->create<sensor_value_t>("sensors/lo_locked")
            .publish(std::bind(&ubx_xcvr::get_locked, this, "TXLO"));
        get_tx_subtree()->create<double>("gains/PGA0/value")
            .coerce(std::bind(&ubx_xcvr::set_tx_gain, this, std::placeholders::_1)).set(0);
        get_tx_subtree()->create<meta_range_t>("gains/PGA0/range")
            .set(ubx_tx_gain_range);
        get_tx_subtree()->create<double>("freq/value")
            .coerce(std::bind(&ubx_xcvr::set_tx_freq, this, std::placeholders::_1))
        ...
        get_tx_subtree()->create<std::string>("antenna/value")
            .subscribe(std::bind(&ubx_xcvr::set_tx_ant, this, std::placeholders::_1))
        ...
        get_tx_subtree()->create<int64_t>("sync_delay")
            .subscribe(std::bind(&ubx_xcvr::set_sync_delay, this, true, std::placeholders::_1))
            .set(-8);
        ...
        get_rx_subtree()->create<sensor_value_t>("sensors/lo_locked")
            .publish(std::bind(&ubx_xcvr::get_locked, this, "RXLO"));
        get_rx_subtree()->create<double>("gains/PGA0/value")
            .coerce(std::bind(&ubx_xcvr::set_rx_gain, this, std::placeholders::_1))
            .set(0);
        get_rx_subtree()->create<meta_range_t>("gains/PGA0/range")
            .set(ubx_rx_gain_range);
        get_rx_subtree()->create<double>("freq/value")
            .coerce(std::bind(&ubx_xcvr::set_rx_freq, this, std::placeholders::_1))
            .set(ubx_freq_range.start());
        ...
        get_rx_subtree()->create<std::string>("antenna/value")
            .subscribe(std::bind(&ubx_xcvr::set_rx_ant, this, std::placeholders::_1)).set("RX2");
        ...
        get_rx_subtree()->create<int64_t>("sync_delay")
            .subscribe(std::bind(&ubx_xcvr::set_sync_delay, this, false, std::placeholders::_1))
            .set(-8);
    }
