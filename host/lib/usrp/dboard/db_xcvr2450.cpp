...
xcvr2450::xcvr2450(ctor_args_t args) : xcvr_dboard_base(args){
    ...
    this->get_rx_subtree()->create<sensor_value_t>("sensors/lo_locked")
        .publish(std::bind(&xcvr2450::get_locked, this));
    this->get_rx_subtree()->create<sensor_value_t>("sensors/rssi")
        .publish(std::bind(&xcvr2450::get_rssi, this));
    BOOST_FOREACH(const std::string &name, xcvr_rx_gain_ranges.keys()){
        this->get_rx_subtree()->create<double>("gains/"+name+"/value")
            .coerce(std::bind(&xcvr2450::set_rx_gain, this, std::placeholders::_1, name))
            .set(xcvr_rx_gain_ranges[name].start());
        this->get_rx_subtree()->create<meta_range_t>("gains/"+name+"/range")
            .set(xcvr_rx_gain_ranges[name]);
    }
    this->get_rx_subtree()->create<double>("freq/value")
        .coerce(std::bind(&xcvr2450::set_lo_freq, this, std::placeholders::_1))
        .set(double(2.45e9));
    this->get_rx_subtree()->create<meta_range_t>("freq/range")
        .set(xcvr_freq_range);
    this->get_rx_subtree()->create<std::string>("antenna/value")
        .subscribe(std::bind(&xcvr2450::set_rx_ant, this, std::placeholders::_1))
    ...
    this->get_rx_subtree()->create<double>("bandwidth/value")
        .coerce(std::bind(&xcvr2450::set_rx_bandwidth, this, std::placeholders::_1)) //complex bandpass bandwidth
    ...
    BOOST_FOREACH(const std::string &name, xcvr_tx_gain_ranges.keys()){
        this->get_tx_subtree()->create<double>("gains/"+name+"/value")
            .coerce(std::bind(&xcvr2450::set_tx_gain, this, std::placeholders::_1, name))
    ...
    this->get_tx_subtree()->create<std::string>("antenna/value")
        .subscribe(std::bind(&xcvr2450::set_tx_ant, this, std::placeholders::_1))
    ...
    this->get_tx_subtree()->create<double>("bandwidth/value")
        .coerce(std::bind(&xcvr2450::set_tx_bandwidth, this, std::placeholders::_1)) //complex bandpass bandwidth
