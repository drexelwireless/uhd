...
e100_impl::e100_impl(const uhd::device_addr_t &device_addr){
    ...
    _tree->create<mboard_eeprom_t>(mb_path / "eeprom")
        .set(mb_eeprom)
        .subscribe(std::bind(&e100_impl::set_mb_eeprom, this, std::placeholders::_1));
    ...
    _tree->create<double>(mb_path / "tick_rate")
        .publish(std::bind(&e100_clock_ctrl::get_fpga_clock_rate, _clock_ctrl))
        .subscribe(std::bind(&fifo_ctrl_excelsior::set_tick_rate, _fifo_ctrl, std::placeholders::_1))
        .subscribe(std::bind(&e100_impl::update_tick_rate, this, std::placeholders::_1));
    ...
    _tree->create<double>(rx_codec_path / "gains/pga/value")
        .coerce(std::bind(&e100_impl::update_rx_codec_gain, this, std::placeholders::_1));
    _tree->create<std::string>(tx_codec_path / "name").set("ad9522");
    _tree->create<meta_range_t>(tx_codec_path / "gains/pga/range").set(e100_codec_ctrl::tx_pga_gain_range);
    _tree->create<double>(tx_codec_path / "gains/pga/value")
        .subscribe(std::bind(&e100_codec_ctrl::set_tx_pga_gain, _codec_ctrl, std::placeholders::_1))
        .publish(std::bind(&e100_codec_ctrl::get_tx_pga_gain, _codec_ctrl));

    ////////////////////////////////////////////////////////////////////
    // and do the misc mboard sensors
    ////////////////////////////////////////////////////////////////////
    _tree->create<sensor_value_t>(mb_path / "sensors/ref_locked")
        .publish(std::bind(&e100_impl::get_ref_locked, this));
        ...
        if (_gps and _gps->gps_detected())
        {
            BOOST_FOREACH(const std::string &name, _gps->get_sensors())
            {
                _tree->create<sensor_value_t>(mb_path / "sensors" / name)
                    .publish(std::bind(&gps_ctrl::get_sensor, _gps, name));
            }
        }
        else
        {
    ...
    _tree->create<subdev_spec_t>(mb_path / "rx_subdev_spec")
        .subscribe(std::bind(&e100_impl::update_rx_subdev_spec, this, std::placeholders::_1));
    _tree->create<subdev_spec_t>(mb_path / "tx_subdev_spec")
        .subscribe(std::bind(&e100_impl::update_tx_subdev_spec, this, std::placeholders::_1));
    ...
    for (size_t dspno = 0; dspno < num_rx_dsps; dspno++)
    {
        ...
        _tree->create<double>(rx_dsp_path / "rate/value")
            ...
            .subscribe(std::bind(&e100_impl::update_rx_samp_rate, this, dspno, std::placeholders::_1));
    ...
    _tree->create<double>(mb_path / "tx_dsps/0/rate/value")
        ...
        .subscribe(std::bind(&e100_impl::update_tx_samp_rate, this, 0, std::placeholders::_1));
    ...
    _tree->create<std::string>(mb_path / "clock_source/value")
        .subscribe(std::bind(&e100_impl::update_clock_source, this, std::placeholders::_1));
    ...
    _tree->create<dboard_eeprom_t>(mb_path / "dboards/A/rx_eeprom")
        .set(rx_db_eeprom)
        .subscribe(std::bind(&e100_impl::set_db_eeprom, this, "rx", std::placeholders::_1));
    _tree->create<dboard_eeprom_t>(mb_path / "dboards/A/tx_eeprom")
        .set(tx_db_eeprom)
        .subscribe(std::bind(&e100_impl::set_db_eeprom, this, "tx", std::placeholders::_1));
    _tree->create<dboard_eeprom_t>(mb_path / "dboards/A/gdb_eeprom")
        .set(gdb_eeprom)
        .subscribe(std::bind(&e100_impl::set_db_eeprom, this, "gdb", std::placeholders::_1));
    ...
    BOOST_FOREACH(const std::string &name, _tree->list(db_tx_fe_path)){
        _tree->access<double>(db_tx_fe_path / name / "freq" / "value")
            .subscribe(std::bind(&e100_impl::set_tx_fe_corrections, this, std::placeholders::_1));
    }
    const fs_path db_rx_fe_path = mb_path / "dboards" / "A" / "rx_frontends";
    BOOST_FOREACH(const std::string &name, _tree->list(db_rx_fe_path)){
        _tree->access<double>(db_rx_fe_path / name / "freq" / "value")
            .subscribe(std::bind(&e100_impl::set_rx_fe_corrections, this, std::placeholders::_1));
    }
    ...
    _tree->access<double>(mb_path / "tick_rate") //now subscribe the clock rate setter
        .subscribe(std::bind(&e100_clock_ctrl::set_fpga_clock_rate, _clock_ctrl, std::placeholders::_1));
